      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <Step
            ...
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-gradient-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>}
          />
          <Step
            number="4"
            ...
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-gradient-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
          />
        </div>
      </div>
    </section>
